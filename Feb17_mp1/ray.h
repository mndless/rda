...
/* Function pointers that can be overridden to provide polymorphic */
/* behavior..                                                      */
   ...
   void    (*specular)(struct object_type *, struct material_type *, drgb_t );
...
{
   void    (*getamb)  (struct object_type *, material_t *, drgb_t );
   void    (*getdiff) (struct object_type *, material_t *, drgb_t );
}  pshader_t;
